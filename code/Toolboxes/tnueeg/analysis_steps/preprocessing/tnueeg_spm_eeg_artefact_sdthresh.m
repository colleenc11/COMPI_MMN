function res = tnueeg_spm_eeg_artefact_sdthresh(S)
%TNUEEG_SPM_EEG_ARTEFACT_SDTHRESH Modified SPM function:
...
clf
subplot(2, 1 , 1)
plot(spikes,ones(length(spikes),1)*S.threshold*sd_eeg,'r.');
hold on;
plot(eog_filt);
