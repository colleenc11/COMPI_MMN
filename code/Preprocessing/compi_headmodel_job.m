function [ job ] = compi_headmodel_job( D, fid, details, options )
% -------------------------------------------------------------------------
% COMPI_HEADMODEL_JOB Defines a job to run a headmodel for an EEG data set
...
switch options.eeg.preproc.mrifile
    case 'template'
    ...
    case 'subject'
        job{1}.spm.meeg.source.headmodel.meshing.meshes.mri = {details.mri};
