function compi_2ndlevel_erpstats_groupmean( scndlvlroot, imagePaths, factorName )
...
job = compi_getjob_2ndlevel_onesample_ttest_cov(scndlvlroot, scans, factorName, covars, options);
spm_jobman('run', job);
