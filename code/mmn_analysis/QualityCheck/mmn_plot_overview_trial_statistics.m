function figureHandle = mmn_plot_overview_trial_statistics(subNames, nTrialsInitial, nEyeblinks, ...
    nArtefacts, nBadchannels, nGoodTrialsTone, nEyeartefacts)
%MNKET_PLOT_OVERVIEW_TRIAL_STATISTICS Plots an overview of the number of trials per subject which
%had to be excluded in the preprocessing (including bad channels and final number of good trials)
%using barplots for one condition in the MNKET study. 
%
