function fh = compi_diagnostics_effect_of_EB_corr(Dbefore, Dafter, channels, trials)
% -------------------------------------------------------------------------
% COMPI_DIAGNOSTICS_EFFECT_OF_EB_CORR Plots data from selected channels and
% trials from two SPM EEG data sets (before and after EB correction) side 
% by side to inspect the result of the EB correction step on the data. 
