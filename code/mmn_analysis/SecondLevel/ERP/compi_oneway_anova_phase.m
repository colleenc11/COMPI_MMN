function [job] = compi_oneway_anova_phase(imagePaths, scndlvlroot, covars, options)
%-------------------------------------------------------------------
% Description.
%-------------------------------------------------------------------
...
%     job{1}.spm.stats.factorial_design.cov(i_cov).c = ([covars.(i_cov); covars.(i_cov); covars.(i_cov)]);
...
%%% PHASE %%%
job{3}.spm.stats.con.consess{1}.fcon.name = 'Stable1';
job{3}.spm.stats.con.consess{1}.fcon.convec = [1 0 0];
job{3}.spm.stats.con.consess{1}.fcon.sessrep = 'none';
job{3}.spm.stats.con.consess{2}.fcon.name = ['Volatile'];
job{3}.spm.stats.con.consess{2}.fcon.convec = [0 1 0];
job{3}.spm.stats.con.consess{2}.fcon.sessrep = 'none';
job{3}.spm.stats.con.consess{3}.fcon.name = 'Stable2';
job{3}.spm.stats.con.consess{3}.fcon.convec = [0 0 1];
job{3}.spm.stats.con.consess{3}.fcon.sessrep = 'none';

%%% PHASE COMPARISON %%%
job{3}.spm.stats.con.consess{4}.tcon.name = 'Stable1>Volatile';
job{3}.spm.stats.con.consess{4}.tcon.convec = [1 -1 0];
job{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
job{3}.spm.stats.con.consess{5}.tcon.name = 'Stable1<Volatile';
job{3}.spm.stats.con.consess{5}.tcon.convec = [-1 1 0];
job{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';

job{3}.spm.stats.con.consess{6}.tcon.name = 'Stable1>Stable2';
job{3}.spm.stats.con.consess{6}.tcon.convec = [1 0 -1];
job{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
job{3}.spm.stats.con.consess{7}.tcon.name = 'Stable1<Stable2';
job{3}.spm.stats.con.consess{7}.tcon.convec = [-1 0 1];
job{3}.spm.stats.con.consess{7}.tcon.sessrep = 'none';

job{3}.spm.stats.con.consess{8}.tcon.name = 'Volatile>Stable2';
job{3}.spm.stats.con.consess{8}.tcon.convec = [0 1 -1];
job{3}.spm.stats.con.consess{8}.tcon.sessrep = 'none';
job{3}.spm.stats.con.consess{9}.tcon.name = 'Volatile<Stable2';
job{3}.spm.stats.con.consess{9}.tcon.convec = [0 -1 1];
job{3}.spm.stats.con.consess{9}.tcon.sessrep = 'none';

job{3}.spm.stats.con.consess{10}.tcon.name = 'Stable>Volatile';
job{3}.spm.stats.con.consess{10}.tcon.convec = [1 -1 1];
job{3}.spm.stats.con.consess{10}.tcon.sessrep = 'none';
job{3}.spm.stats.con.consess{11}.tcon.name = 'Stable<Volatile';
job{3}.spm.stats.con.consess{11}.tcon.convec = [-1 1 -1];
job{3}.spm.stats.con.consess{11}.tcon.sessrep = 'none';

%%% COVARIATES %%%
% job{3}.spm.stats.con.consess{12}.fcon.name = 'Age';
% job{3}.spm.stats.con.consess{12}.fcon.convec = [0 0 0 1];
