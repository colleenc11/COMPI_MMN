...
%--------------------------------------------------------------------------
% COMPI_PLOT_TRIALSTATS Collect and plot preprocessing trial statistics.
...
switch options.eeg.preproc.eyeCorrMethod
    case 'reject'
        ...
        trialStatsTable = table(nTrialsInitial', ...
            ...
            'nGoodTrialsTone'});
        % plot
        fh = compi_plot_overview_trial_statistics(options.subjectIDs, nTrialsInitial, ...
    ...
    case {'SSP', 'PSSP'}
        ...
        trialStatsTable = table(nTrialsInitial', ...
            ...
            'nGoodTrialsTone'});
        % plot
        fh = compi_plot_overview_trial_statistics(options.subjects.all, nTrialsInitial, ...
