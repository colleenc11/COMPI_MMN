function tayeeg_plot_blobs(regressorName, options)
%--------------------------------------------------------------------------
% TAYEEG_PLOT_BLOBS Plot and save EEG blob images. Requires T or F-nifti
% image, max F or max t-threshold for intensity map and extent threshold
% (k - minimum number of voxels per blob). Adjust k if you only want one
% blob to survive.
%   IN:     options         - the struct that holds all analysis options
%           regressorName   - name of regressor to plot
%   OUT:    --
%--------------------------------------------------------------------------
