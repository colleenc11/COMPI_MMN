...
try
    ...
    switch lower(details.eeg.preproc.eyeCorrMethod)
        case 'reject'
            ...
            saveas(fh, details.eeg.eyeblinkoverlapfigure, 'fig');
            close(fh);            
    end
    ...
    % Note, we make the very strong assumption here that the first of the
    % events within each epoch is the tone (could in principle also be a
    % trigger!)
